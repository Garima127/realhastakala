                    ...
                    <div class="product-slider">
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="/product">Hand Knitted Infinity Scarf</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="/product">100 Decorative Paper Roses</a></h3>
                                    <p class="price"><del>3500</del> Rs.3000.00</p>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="/product">Sukul Themed Coasters</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="/product">Painted Arya Tara Face</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                            </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="/product">Knitted Baby Shoes</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
            ...
            <div class="container" data-animate="fadeInUpBig">
                <div class="col-md-12">
                    <div class="box slideshow">
                        <h3>Get Training</h3>
                        <p class="lead">Learn From talented Artisans</p>
